...
page_is_loaded_search_area_y1 := 63
page_is_loaded_search_area_x2 := 101
page_is_loaded_search_area_y2 := 95


; Координаты кнопки перехода в режим чтения Firefox
reader_mode_enable_button_x := 218
reader_mode_enable_button_y := 82
...
reader_mode_serch_area_y1 := 192 
reader_mode_serch_area_x2 := 38
reader_mode_serch_area_y2 := 230 


; Кнопки управления чтением в режиме Чтеца
reader_main_button_x := 20
reader_main_button_y := 250

reader_prev_button_x := 100
reader_prev_button_y := 250

reader_next_button_x := 300
reader_next_button_y := 250

reader_play_pause_button_x := 195
reader_play_pause_button_y := 250
